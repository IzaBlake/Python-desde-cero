...
# 6. Usa un bucle for para recorrer el diccionario {"name": "Iza", "age": 23, "country": "CDMX"} e imprime las claves.

person = {"name": "Iza", "age": 23, "country": "CDMX"}
for key in person:
    print(key)
...
# 10. Usa un bucle for para recorrer una lista de nombres y detener el bucle cuando se encuentre el nombre "Iza".

names = ["Sara", "Iza", "Pedro"]
for name in names:
    if name == "Iza":
        print("Se encontró a Iza")
        break
    print(name)

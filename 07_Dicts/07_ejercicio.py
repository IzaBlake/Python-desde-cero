...
my_dict = {"name": "Iza", "age": 23, "country": "CDMX"}
print(my_dict)
...
# 4. Modifica el valor de la clave age en el diccionario para que sea 23. Imprime el diccionario actualizado.
...
# 7. Verifica si la clave age está presente en el diccionario {"name": "Iza", "age": 23, "country": "CDMX"}.
